      ...
      <div className="about__container grid">
        ...
        <div className="about__data grid">
          <div className="about__info">
            <p className="about__description">I am Rishabh Kushwaha, Web developer from Delhi, India. I have rich experience in Website designing, building and customization. Furthermore, I am good at problem solving.</p>
